...
function Dashboard(props) {
  ...
  const drawer = (
    <div>
      ...
      <Divider />
      <List>
        {["Dashboard", "Profile", "Account", "Payin", "Payout","Commission"].map(
          (text, index) => (
                ...
                <ListItemIcon>
                  {index === 0 ? (
                    ...
                    <AccountBalanceWalletOutlinedIcon
                      onClick={() => {setToggle("Account");setMobileOpen(false);}}
                    />
                  ) : index === 3 ? (
                    ...
                    <PercentIcon onClick={() => {setToggle("Payout");setMobileOpen(false);}} />
                  )
                  : (
